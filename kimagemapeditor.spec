...
Version  : 21.12.0
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kimagemapeditor-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kimagemapeditor-21.12.0.tar.xz
...
%prep
%setup -q -n kimagemapeditor-21.12.0
cd %{_builddir}/kimagemapeditor-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639629916
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kimagemapeditor-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kimagemapeditor/2d69f4c601571117df29fd61c2ce9117b0879da7
pushd clr-build
%make_install
popd
