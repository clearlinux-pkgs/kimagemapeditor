...
Version  : 19.04.2
Release  : 11
URL      : https://download.kde.org/stable/applications/19.04.2/src/kimagemapeditor-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/kimagemapeditor-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/kimagemapeditor-19.04.2.tar.xz.sig
...
%prep
%setup -q -n kimagemapeditor-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559891495
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
