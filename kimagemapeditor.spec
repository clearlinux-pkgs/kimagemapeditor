...
Version  : 19.08.2
Release  : 15
URL      : https://download.kde.org/stable/applications/19.08.2/src/kimagemapeditor-19.08.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.2/src/kimagemapeditor-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/kimagemapeditor-19.08.2.tar.xz.sig
...
%prep
%setup -q -n kimagemapeditor-19.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570744999
mkdir -p clr-build
pushd clr-build
