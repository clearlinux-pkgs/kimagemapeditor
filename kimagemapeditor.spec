...
Version  : 24.05.1
Release  : 71
URL      : https://download.kde.org/stable/release-service/24.05.1/src/kimagemapeditor-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kimagemapeditor-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kimagemapeditor-24.05.1.tar.xz.sig
...
%setup -q -n kimagemapeditor-24.05.1
cd %{_builddir}/kimagemapeditor-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718410399
mkdir -p clr-build
pushd clr-build
