...
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/kimagemapeditor-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/kimagemapeditor-20.08.3.tar.xz.sig
...
%prep
%setup -q -n kimagemapeditor-20.08.3
cd %{_builddir}/kimagemapeditor-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604605120
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kimagemapeditor-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/kimagemapeditor/2d69f4c601571117df29fd61c2ce9117b0879da7
pushd clr-build
%make_install
popd
