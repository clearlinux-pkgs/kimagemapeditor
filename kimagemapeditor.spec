...
Version  : 22.08.3
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.08.3/src/kimagemapeditor-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kimagemapeditor-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kimagemapeditor-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kimagemapeditor-22.08.3
cd %{_builddir}/kimagemapeditor-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667879638
mkdir -p clr-build
pushd clr-build
