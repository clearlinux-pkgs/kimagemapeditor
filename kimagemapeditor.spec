...
Version  : 22.08.1
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.1/src/kimagemapeditor-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kimagemapeditor-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kimagemapeditor-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kimagemapeditor-22.08.1
cd %{_builddir}/kimagemapeditor-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662770454
mkdir -p clr-build
pushd clr-build
